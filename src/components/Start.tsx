          ...
          <div className="v1_15">
            ...
            <div className="v1_130">
              <div className="v1_8" onClick={fileInput} style={{
                backgroundImage : imgPath  ? `url(${localStorage.getItem("img1")})` : `url(${p1})`,
        ...
        <div className="row">
          <div className="v1_16">
            ...
            <div className="v1_21" onClick={fileInput} style={{
                backgroundImage : imgPath2  ? `url(${localStorage.getItem("img2")})` : `url(${p2})`,
                backgroundSize : "cover"
             }}>
            <input
                  type="file"
        ...
        <div className="row">
          <div className="v1_27">
              <button className="v1_25" onClick={
                () => validate() === true ? navigate("/play", {state :{ pl1: player1, pl2: player2, noOfGames : noOfGames }, replace : true}) : ""
                }>
