...
import player1default from "../assets/images/player1default.svg";
import player2default from "../assets/images/player2default.svg";
type Props = {};
type Names = {
  pl1: string;
  pl2: string;
...
const Play = (props: Props) => {
  ...
  const { pl1, pl2, noOfGames } = state.state as Names;
